...
`AI News Open v1.2.39 · Recovery Override FAQ and Revalidation Coverage`
...
AI News Open `v1.2.39` hardens extraction quality for recovery-override-faq, continuity-revalidation-matrix, and audit-replay-checklist layouts across more developer-doc publishers.
